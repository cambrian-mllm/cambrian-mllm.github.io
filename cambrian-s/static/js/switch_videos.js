function switchVideo(prefix, videoContainerId, preview_id) {
    ...
    if (video1Container) video1Container.style.display = 'none';
    if (video2Container) video2Container.style.display = 'none';
    ...
    if (video2Container) {
        var videos = video2Container.getElementsByTagName('video');
        for (var i = 0; i < videos.length; i++) {
            videos[i].pause();
        }
    }
